@testset "Utils display" begin
    @test PtyLab.complex_show([1.0 + 0im, 0 + 0im, -1im, 1im]) == ColorTypes.HSV{Float64}[HSV{Float64}(0.0,1.0,1.0), HSV{Float64}(0.0,1.0,0.0), HSV{Float64}(-90.0,1.0,1.0), HSV{Float64}(90.0,1.0,1.0)]
